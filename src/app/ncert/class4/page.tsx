...
const classData = {
  title: "Class 4",
  description: "NCERT Class 4 syllabus with interactive learning tools and resources",
  subjects: [
    {
      id: 1,
      title: "English",
      ...
      url: "/ncert/class4/english"
    },
    {
      id: 2,
      title: "Mathematics",
      description: "Fractions, decimals and advanced arithmetic",
      units: 4,
      chapters: 10,
      progress: 0,
      image: "/images/logo.jpeg",
      ...
      url: "/ncert/class4/mathematics"
    },
    {
      id: 3,
      title: "Hindi",
      description: "Complex language structures and creative writing",
      units: 4,
      chapters: 10,
      progress: 0,
      image: "/images/logo.jpeg",
      ...
      url: "/ncert/class4/hindi"
    },
    {
      id: 4,
      title: "Environmental Studies",
      description: "Advanced environmental concepts and sustainability",
      units: 4,
      chapters: 10,
      progress: 0,
      image: "/images/logo.jpeg",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Complete syllabus for Class 4 subjects
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => window.open('/pdfs/class4/syllabus.pdf', '_blank')}
                >
                  View Syllabus
                </Button>
              </CardFooter>
            ...
            <Card>
              ...
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => router.push('/ncert/class4/videos')}
                >
                  Watch Videos
                </Button>
              </CardFooter>
            ...
            <Card>
              ...
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => router.push('/ncert/class4/activities')}
                >
                  Explore Activities
                </Button>
              </CardFooter>
