...
const classData = {
  title: "Class 3",
  description: "NCERT Class 3 syllabus with interactive learning tools and resources",
  subjects: [
    {
      id: 1,
      title: "English",
      ...
      url: "/ncert/class3/english"
    },
    {
      id: 2,
      title: "Mathematics",
      description: "Multiplication, division and advanced geometry",
      units: 4,
      chapters: 8,
      progress: 0,
      image: "/images/logo.jpeg",
      ...
      url: "/ncert/class3/mathematics"
    },
    {
      id: 3,
      title: "Hindi",
      description: "Advanced Hindi reading and composition",
      units: 4,
      chapters: 8,
      progress: 0,
      image: "/images/logo.jpeg",
      ...
      url: "/ncert/class3/hindi"
    },
    {
      id: 4,
      title: "Environmental Studies",
      description: "Nature, resources and human environment",
      units: 4,
      chapters: 8,
      progress: 0,
      image: "/images/logo.jpeg",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Complete syllabus for Class 3 subjects
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => window.open('/pdfs/class3/syllabus.pdf', '_blank')}
                >
                  View Syllabus
                </Button>
              </CardFooter>
            ...
            <Card>
              ...
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => router.push('/ncert/class3/videos')}
                >
                  Watch Videos
                </Button>
              </CardFooter>
            ...
            <Card>
              ...
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => router.push('/ncert/class3/activities')}
                >
                  Explore Activities
                </Button>
              </CardFooter>
