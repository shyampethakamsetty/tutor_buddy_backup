...
const classData = {
  title: "Class 1",
  description: "NCERT Class 1 syllabus with interactive learning tools and resources",
  subjects: [
    {
      id: 1,
      title: "English",
      description: "Reading, writing, and basic language skills",
      units: 2,
      chapters: 4,
      progress: 0,
      ...
      url: "/ncert/class1/english"
    },
    {
      id: 2,
      title: "Mathematics",
      description: "Numbers, shapes, and basic arithmetic",
      units: 2,
      chapters: 4,
      progress: 0,
      image: "/images/logo.jpeg",
      ...
      url: "/ncert/class1/mathematics"
    },
    {
      id: 3,
      title: "Hindi",
      description: "Basic Hindi reading and writing skills",
      units: 2,
      chapters: 4,
      progress: 0,
      image: "/images/logo.jpeg",
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Complete syllabus for Class 1 subjects
                </CardDescription>
              </CardHeader>
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => window.open('/pdfs/class1/syllabus.pdf', '_blank')}
                >
                  View Syllabus
                </Button>
              </CardFooter>
            ...
            <Card>
              ...
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => router.push('/ncert/class1/videos')}
                >
                  Watch Videos
                </Button>
              </CardFooter>
            ...
            <Card>
              ...
              <CardFooter>
                <Button 
                  variant="outline" 
                  className="w-full"
                  onClick={() => router.push('/ncert/class1/activities')}
                >
                  Explore Activities
                </Button>
              </CardFooter>
