...
const unitData = {
  ...
  description: "Exploration of family relationships and understanding parts of the body",
  chapters: [
    {
      id: 1,
      title: "Two Little Hands",
      description: "A rhyme about body parts and their functions",
      estimatedTime: "15 min",
      progress: 0,
      pdfUrl: "/pdfs/class1/english/aemru1c1.pdf",
      pageUrl: "/ncert/class1/english/unit1/chapter1"
    },
    {
      id: 2,
      title: "Greetings",
      description: "Learning different ways to greet people",
      estimatedTime: "20 min",
      progress: 0,
      pdfUrl: "/pdfs/class1/english/aemru1c2.pdf",
      pageUrl: "/ncert/class1/english/unit1/chapter2"
    }
  ],
  totalProgress: 0
}
        ...
        <div className="mt-8 border-t pt-6">
          <div className="flex justify-between items-center">
            ...
            <Button
              ...
              className="flex items-center"
              onClick={() => {
                router.push('/ncert/class1/english/unit2')
              }}
            >
              Next Unit
              <ChevronRight className="w-4 h-4 ml-2" />
