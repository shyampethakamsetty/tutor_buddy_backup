...
## Introduction
This chapter introduces children to different parts of the body through engaging rhymes and activities. Children learn about body parts and their functions in a fun, rhythmic way.
...
## Vocabulary
- **hand**: The part at the end of a person's arm that includes the fingers
- **leg**: One of the long limbs on which a person or animal stands and walks
- **eye**: The organ of sight that we use to see things
- **ear**: The organ on either side of the head that we use to hear sounds
- **nose**: The part of the face that we use to smell and breathe
- **mouth**: The opening in the face that we use to eat and speak
- **head**: The upper part of the human body containing the brain, eyes, ears, nose, and mouth

## Activities
1. Touch and name different parts of your body
2. Sing along with the 'Head, Shoulders, Knees and Toes' song
3. Draw a picture of yourself and label the body parts
4. Play Simon Says with body parts (e.g., 'Simon says touch your nose')

## Questions
1. What do we use our hands for?
2. What do we use our legs for?
3. How many eyes do we have?
4. What do we use our mouth for?
5. Which body part helps us to smell?`;

// Quiz questions
const QUIZ_QUESTIONS = [
  {
    id: 'q1',
    question: 'What do we use our hands for?',
    options: ['To walk', 'To clap', 'To smell', 'To see'],
    correctAnswer: 'To clap',
    explanation: 'The poem says "Two little hands go clap, clap, clap" and "Hands to clap".'
  },
  {
    id: 'q2',
    question: 'What do we use our legs for?',
    options: ['To talk', 'To smell', 'To walk', 'To hear'],
    correctAnswer: 'To walk',
    explanation: 'The poem says "Two little legs go tap, tap, tap" and "legs to walk".'
  },
  {
    id: 'q3',
    ...
    correctAnswer: 'Two',
    explanation: 'The poem says "Two little eyes are open wide" and "Two little eyes to look around".'
  },
  {
    id: 'q4',
    question: 'What do we use our mouth for?',
    options: ['To see', 'To hear', 'To smell', 'To eat and talk'],
    correctAnswer: 'To eat and talk',
    explanation: 'The poem says "One little mouth that likes to eat" and "mouth to talk".'
  },
  {
    id: 'q5',
    ...
    correctAnswer: 'Nose',
    explanation: 'The poem says "One little nose to smell and breathe".'
  }
];
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
          <div>
            ...
            <h1 className="text-3xl font-bold">A Happy Child</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-2">
              Unit 1, Chapter 1 - NCERT Class 1 English
            </p>
          </div>
          ...
          <Button 
            ...
            onClick={() => window.open('/pdfs/class1/english/aemru1c1.pdf', '_blank')}
          >
            ...
            <Card>
              ...
              <CardContent>
                <div className="h-[500px]">
                  <LearningToolsProvider questionRef="class1-english-unit1-chapter1" initialText="">
                    <AITutorChat 
                      showTitle={false} 
                      contextText={`Class 1, English, Unit 1, Chapter 1: A Happy Child\n\n${CHAPTER_CONTENT}`} 
                    />
